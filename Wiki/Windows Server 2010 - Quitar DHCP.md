...
site A
si haces un ipconfig y no tenes la 10.0.1.10 debes quitarle el dhcp en las configuraciones de adaptador. especificamente configurando el que dice ipv4

la ip estatica debe ser 10.0.1.10
la mascara es un /16, es decir: 255.255.255.0
y la puerta de enlace (gateway) debe llevar al forti -> 10.0.1.254
