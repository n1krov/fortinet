...
{brevemente nomas porqeu es a modo de glosario}

heartbeat es un link qeu permite la comunicacion entre equipos fortigate dentro de un cluster para la distribucion del trafico, deteccion de caidas, etc

![[Pasted image 20260114095852.png]]