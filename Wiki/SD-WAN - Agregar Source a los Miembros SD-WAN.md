...
---
como se puede ver en la imagen, la GUI no nos da esa posibilidad de poder configurar el SOURCE IP del [[SD-WAN]] member, por lo que resta ahcerlo en consola por [[CLI]]

![[Captura de pantalla_20260129_081453.png]]

como hacerlo

`config system sdwan`

si efectuamos un `show` podremos ver config zone y los config members, como se muestra en la imagena continuacion

![[Captura de pantalla_20260129_081801.png]]

`config members`
`edit 3`

![[Captura de pantalla_20260129_082101.png]]

`set source <ip>` debe ser la ip de la interfaz, en este caso es la loopback, pero si es otra fuente debe ser la ip source
