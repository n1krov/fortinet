...
en Policys y objects > addresses > create new address
creamos un objeto tipo Geography que va a contener el PAIS a bloquear

si tienes muchos paiese puedes crear un GRUPO para agrupar los paises *en Policys y objects > addresses > create new address group*
