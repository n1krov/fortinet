...
Si nosotros desenchufamos un cable de red ya sea del forti o del router forti lo detectara y si tenemos una interfaz de backup para que siga corriendo lo va a cambiar automaticamente

Pero Fortigate de por si no detecta si las interfaces (por cable) estan teniendo salida a internet

es por eso qeu se configura un link health para que forti pregunte por una interfaz a un servidor usando PING u otra herramienta


desde la [[CLI]] podemos verlo
