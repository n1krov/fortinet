...
ipsec es un conjunto de protocolos que trabajan de manera conjunta para poder brindar conexiones seguras 

esto es muy utilizado en las empresas ya que permiten conexiones remotas por vpn y tuneles

![[Captura de pantalla_20260120_104604.png]]

El protocolo [[IKE]] cuanod **NO** esta en modo [[NAT]]
- Utiliza el protocolo 17: por UDP en el puerto 500

[[IKE]] si esta detras de un NAT
- corre protocolo 17: UDP en puerto 4500

si el protocolo [[ESP]] cuando **NO** esta en modo NAT
- corre protocolo 50

si esta detras de un NAT
- corre protocolo 17 por UDP por el puerto 4500
